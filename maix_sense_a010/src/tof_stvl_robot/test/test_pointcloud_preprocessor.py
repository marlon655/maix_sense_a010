...
def test_production_yaml_contains_only_preprocessor_parameters():
    ...
    required = {
        ...
        'terrain_seed_x_min', 'terrain_seed_x_max', 'terrain_seed_half_width',
        ...
        'terrain_transition_enabled', 'terrain_transition_max_length',
...
def test_stvl_reference_uses_only_production_topic():
    ...
    source = config['stvl_layer']['tof_obstacles']
    assert config['stvl_layer']['observation_sources'] == 'tof_obstacles'
